...
// 3 -----------------------------------------------------------------------------------------------------------
	...
	function customTraversions(){
		...
		function moveNavigation(){
			...
			if(nav.length > 0){
				nav.insertAfter('#global-header');
			}
		}
		
	 if (size.indexOf("alphascreen") !=-1 || size.indexOf("betascreen") !=-1 || size.indexOf("charliecreen") !=-1){
	 	moveNavigation()
	 }
	}
...
// 4 -----------------------------------------------------------------------------------------------------------
 	...
 	function toggledNav(){
	 	$('#menu-button').bind('tap', function(d){ 
...
// 7 -----------------------------------------------------------------------------------------------------------
  ...
  if ((size.indexOf("deltascreen") !=-1 && window.localStorage) || (size.indexOf("echoscreen") !=-1 && window.localStorage)){
  	editableAside();
  }
